...
* Plot `karate` again using `layout_in_circle`.
...
We will use the following function throughout the day to help make the visualizations a little prettier. Run the following code in your environment:
...
Then you can call the function whenever by doing this:
...
sim_graph <- erdos.renyi.game(50, 1/5)
plot.dd(sim_graph)
```
